...
export function exampleExpense() {
    const transaction: Transaction = {
        ...
        movements: [
            { accountId: 'checking-account-id', amount: -150.5, currencyId: 'usd' },
            { accountId: 'groceries-expense-id', amount: 150.5, currencyId: 'usd' },
        ],
    };
...
export function exampleWithAccountMap(
