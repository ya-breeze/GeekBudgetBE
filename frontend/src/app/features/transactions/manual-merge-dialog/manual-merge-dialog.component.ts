...
@Component({
    selector: 'app-manual-merge-dialog',
    standalone: true,
    imports: [
        CommonModule,
        MatDialogModule,
    ...
    templateUrl: './manual-merge-dialog.component.html',
    styleUrl: './manual-merge-dialog.component.scss',
})
export class ManualMergeDialogComponent {
    private readonly dialogRef = inject(MatDialogRef<ManualMergeDialogComponent>);
    private readonly data = inject<ManualMergeData>(MAT_DIALOG_DATA);
