...
type AggregationsAPIService interface {
	...
	GetExpenses(ctx context.Context, from time.Time, to time.Time, outputCurrencyId string, granularity string, includeHidden bool) (ImplResponse, error)
...
// GetExpenses - get expenses for filtered transactions
func (s *AggregationsAPIServiceImpl) GetExpenses(ctx context.Context, from time.Time, to time.Time, outputCurrencyId string, granularity string, includeHidden bool) (ImplResponse, error) {
