...
type ApiDeleteAccountImageRequest struct {
	ctx        context.Context
	ApiService *AccountsAPIService
	id         string
}

func (r ApiDeleteAccountImageRequest) Execute() (*Account, *http.Response, error) {
	return r.ApiService.DeleteAccountImageExecute(r)
}
...
DeleteAccountImage delete account image
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiDeleteAccountImageRequest
*/
func (a *AccountsAPIService) DeleteAccountImage(ctx context.Context, id string) ApiDeleteAccountImageRequest {
	return ApiDeleteAccountImageRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return Account
func (a *AccountsAPIService) DeleteAccountImageExecute(r ApiDeleteAccountImageRequest) (*Account, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountsAPIService.DeleteAccountImage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/accounts/{id}/image"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiUploadAccountImageRequest struct {
	ctx        context.Context
	ApiService *AccountsAPIService
	id         string
	file       *os.File
...
func (r ApiUploadAccountImageRequest) File(file *os.File) ApiUploadAccountImageRequest {
	r.file = file
	return r
}

func (r ApiUploadAccountImageRequest) Execute() (*Account, *http.Response, error) {
	return r.ApiService.UploadAccountImageExecute(r)
}
...
UploadAccountImage Upload account image
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiUploadAccountImageRequest
*/
func (a *AccountsAPIService) UploadAccountImage(ctx context.Context, id string) ApiUploadAccountImageRequest {
	return ApiUploadAccountImageRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return Account
func (a *AccountsAPIService) UploadAccountImageExecute(r ApiUploadAccountImageRequest) (*Account, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountsAPIService.UploadAccountImage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
