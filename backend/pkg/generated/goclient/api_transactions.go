...
type ApiMergeTransactionsRequest struct {
	ctx                      context.Context
	ApiService               *TransactionsAPIService
	mergeTransactionsRequest *MergeTransactionsRequest
}

func (r ApiMergeTransactionsRequest) MergeTransactionsRequest(mergeTransactionsRequest MergeTransactionsRequest) ApiMergeTransactionsRequest {
	r.mergeTransactionsRequest = &mergeTransactionsRequest
	return r
}

func (r ApiMergeTransactionsRequest) Execute() (*Transaction, *http.Response, error) {
	return r.ApiService.MergeTransactionsExecute(r)
}
...
MergeTransactions merge two transactions
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiMergeTransactionsRequest
*/
func (a *TransactionsAPIService) MergeTransactions(ctx context.Context) ApiMergeTransactionsRequest {
	return ApiMergeTransactionsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return Transaction
func (a *TransactionsAPIService) MergeTransactionsExecute(r ApiMergeTransactionsRequest) (*Transaction, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransactionsAPIService.MergeTransactions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/transactions/merge"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.mergeTransactionsRequest == nil {
		return localVarReturnValue, nil, reportError("mergeTransactionsRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.mergeTransactionsRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiParseTransactionRequest struct {
	ctx                     context.Context
	ApiService              *TransactionsAPIService
	transactionParseRequest *TransactionParseRequest
}

func (r ApiParseTransactionRequest) TransactionParseRequest(transactionParseRequest TransactionParseRequest) ApiParseTransactionRequest {
	r.transactionParseRequest = &transactionParseRequest
	return r
}

func (r ApiParseTransactionRequest) Execute() (*TransactionParseResponse, *http.Response, error) {
	return r.ApiService.ParseTransactionExecute(r)
}
...
ParseTransaction parse natural-language text into a transaction
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiParseTransactionRequest
*/
func (a *TransactionsAPIService) ParseTransaction(ctx context.Context) ApiParseTransactionRequest {
	return ApiParseTransactionRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *TransactionsAPIService) ParseTransactionExecute(r ApiParseTransactionRequest) (*TransactionParseResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *TransactionParseResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransactionsAPIService.ParseTransaction")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/transactions/parse"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.transactionParseRequest == nil {
		return localVarReturnValue, nil, reportError("transactionParseRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.transactionParseRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
